Horizontal menubar and standalone vertical menu with keyboard navigation (arrow
keys, Enter/Space to select, Escape to close), nested submenus, separators, and
subtitles. Two factory functions: Menubar (horizontal bar) and Menu (vertical
standalone).
