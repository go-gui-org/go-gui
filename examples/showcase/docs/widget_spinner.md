Animated mathematical curve rendered as a particle trail. Twenty-one named curve
types are available, each with sensible defaults. Override ParamA/B/D for custom
tuning. Optional slow rotation adds visual depth.
