Display raster image files (PNG, JPEG, GIF, BMP, WebP). Supports local paths and
remote HTTP/HTTPS URLs with automatic download caching. Defaults to 100x100 when
