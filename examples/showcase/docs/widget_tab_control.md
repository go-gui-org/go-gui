Tabbed content panels with keyboard navigation (Left/Right/Home/End). Controlled
component: Selected is owned by app state and updated through OnSelect. Supports
drag-reorder.
