Render markdown strings with syntax highlighting, tables, blockquotes, math
(LaTeX via CodeCogs), and mermaid diagrams (via Kroki). Uses the built-in parser
and renders via RTF views internally.
