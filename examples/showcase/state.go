...
func newShowcaseApp() *ShowcaseApp {
	return &ShowcaseApp{
		...
		SidebarOpen:          true,
		ThemeGenSeed:         gui.ThemeDark.WithBorders(true).Cfg.ColorSelect,
		ThemeGenStrategy:     "mono",
		ThemeGenRadius:       gui.ThemeDark.WithBorders(true).Cfg.Radius,
		ThemeGenRadiusText:   floatString(gui.ThemeDark.WithBorders(true).Cfg.Radius),
