// Separate module so the linter's dependency tree stays out of the public
// go-gui module. A tool directive in the root go.mod grew it from 40 to 246
// lines and go.sum from 119 to 997 -- every downstream sibling would inherit
// that module graph. The pinned version lives here and nowhere else.
module github.com/go-gui-org/go-gui/tools/lint
